...
public class Login extends JFrame {
	...
	// Vamos a usar un metodo básico de inicialización por temas educativos, luego en un versión 
	// comercial se puede realacionar con la base de datos
	private void Login() {
		 String Usuario= "hotel1234";
	     String Contraseña="usuario1234";
